<html>
            ...
            <div class="relative flex size-full min-h-screen flex-col bg-dark justify-between group/design-root overflow-x-hidden" style='font-family: "Montserrat", sans-serif;'>
                <div>
                    <!-- Navigation Overlay -->
                    ...
                    <div class="relative flex size-full min-h-screen flex-col bg-dark justify-between group/design-root overflow-x-hidden" style='font-family: "Montserrat", sans-serif;'>
                        <div>
                            <header class="sticky top-0 z-10 bg-dark/90 backdrop-blur-sm border-b border-gold/30">
                                <div class="flex items-center p-4 justify-between">
                                    <!-- Update the button with an ID -->
                                    <button id="openNavBtn" class="flex items-center justify-center rounded-full h-10 w-10 text-gold">
                                        <span class="material-icons-outlined">menu</span>
                                    </button>
                                    <h1 class="gold-gradient text-2xl font-bold tracking-widest">HYPEZA</h1>
                                    <button class="">
                                    </button>
                                </div>
                            </header>
                    <main>
                        <div class="relative">
                            <div class="h-[80vh] bg-cover bg-center flex flex-col justify-end" style='background-image: linear-gradient(0deg, rgba(0, 0, 0, 0.7) 0%, rgba(0, 0, 0, 0.3) 70%), url("https://images.unsplash.com/photo-1549062572-544a64fb0c56?q=80&w=1000");'>
                                ...
                                <div class="flex flex-col gap-2 group">
                                    <div class="w-full bg-center bg-no-repeat aspect-square bg-cover overflow-hidden relative" style='background-image: url("https://images.unsplash.com/photo-1539109136881-3be0616acf4b?q=80&w=1000");'>
                                        <div class="absolute inset-0 bg-dark/40 flex items-center justify-center">
                                            <p class="text-gold text-lg font-medium">Femme</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex flex-col gap-2 group">
                                    <div class="w-full bg-center bg-no-repeat aspect-square bg-cover overflow-hidden relative" style='background-image: url("https://images.unsplash.com/photo-1617127365659-c47fa864d8bc?q=80&w=1000");'>
                                        <div class="absolute inset-0 bg-dark/40 flex items-center justify-center">
                                            <p class="text-gold text-lg font-medium">Homme</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex flex-col gap-2 group">
                                    <div class="w-full bg-center bg-no-repeat aspect-square bg-cover overflow-hidden relative" style='background-image: url("https://images.unsplash.com/photo-1511556820780-d912e42b4980?q=80&w=1000");'>
                                        <div class="absolute inset-0 bg-dark/40 flex items-center justify-center">
                                            <p class="text-gold text-lg font-medium">Accessoires</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="flex flex-col gap-2 group">
                                    <div class="w-full bg-center bg-no-repeat aspect-square bg-cover overflow-hidden relative" style='background-image: url("https://images.unsplash.com/photo-1490481651871-ab68de25d43d?q=80&w=1000");'>
                                        <div class="absolute inset-0 bg-dark/40 flex items-center justify-center">
                                            <p class="text-gold text-lg font-medium">Haute Couture</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
